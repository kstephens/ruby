...
#define is_attrset_id(id) (is_notop_id(id)&&(ID_SCOPE(id))==ID_ATTRSET)
#define is_const_id(id) (is_notop_id(id)&&(ID_SCOPE(id))==ID_CONST)
#define is_class_id(id) (is_notop_id(id)&&(ID_SCOPE(id))==ID_CLASS)
#define is_junk_id(id) (is_notop_id(id)&&(ID_SCOPE(id))==ID_JUNK)
#define id_type(id) (is_notop_id(id) ? (int)(ID_SCOPE(id)) : -1)

#define is_asgn_or_id(id) ((is_notop_id(id)) && \
	((ID_SCOPE(id)) == ID_GLOBAL || \
	 (ID_SCOPE(id)) == ID_INSTANCE || \
	 (ID_SCOPE(id)) == ID_CLASS))
